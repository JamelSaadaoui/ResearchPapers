...
*! Removed lines 384, 385 to allow to run with Stata > 15.0 Update 20.02.2019, by Jan Ditzen (www.jan.ditzen.net) on 12.02.2020

capture progam drop xtpmg2
program define xtpmg2
        version 9
                if replay() {
...
program define EstMG, eclass
        ...
        quie gen byte `touse'=e(sample)
		/// 12.02.2019 - removed lines by Jan Ditzen to allow with Stata > 15.1, update 20.02.2019
