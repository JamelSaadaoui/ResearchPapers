# This code reproduces the result in Figure A.12 of the supplemental online appendix
...
# take unemployment rate to be added as additional control
unemp = data$UNETOT_EA
...
for (r in 1:N) { # estimate local projections for each GPR index
  ...
  data_temp = cbind(SovCISS[-1],GPR[-1],IP_gr,int_rate[-1],unemp[-1]) 
