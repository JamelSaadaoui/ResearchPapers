# This code reproduces the result in Figure A.1 of the supplemental online appendix
...
SovCISS = data$SovCISS_EA_equal_weigths # take the SovCISS for the Euro Area (equal country weights version)
