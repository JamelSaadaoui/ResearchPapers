# This code reproduces the result in Figure A.2 of the supplemental online appendix
...
# take local German GPR index from Alonso-Alvarez et al. (2025) and the German GPR index
# from Bondarenko et al. (2024)
GPR_local = cbind(data$Germany,data$Germany_Bondarenko)

SovCISS = data$SovCISS_EA # take the SovCISS for the Euro Area (equal country weights version)
...
# Plot Figure A.2
label_country = c("Alonso-Alvarez et al. (2025)","Bondarenko et al. (2024)")  
...
for (r in 1:N) {
  ...
  plot(0:H,rep(0,H+1),lwd = 1,type = "l",col = 1,lty = 2,
       xaxs = "i",ylab = "",xlab = "", main = label_country[r],ylim = c(min_plot,max_plot))
